...
import ResultElement from '@/app/components/ResultElement'
    ...
    return (
      <main className='pt-[92.25px] bg-gray-200'>
        <div className='container mx-auto flex flex-col items-center p-4 py-12 min-h-[calc(100vh-92.24px-148.94px)]'>
          <h1 className='w-full text-center pb-8 text-4xl font-semibold text-black'>Found recipes in {category}</h1>
          {isLoading && <img className='w-40 h-40 self-center' src={"https://media.tenor.com/Nzkl6kzykuMAAAAi/animation-logo.gif"} alt='loading gif' width={300} height={300}/>}
